...
SSL_CHECKPOINT = '/kaggle/working/CoW_checkpoints/model_best_COVER_2D_CoW.pth.tar'
NPZ_PATH       = '/kaggle/working/CoW_preprocessed.npz'
COVER_PATH     = '/kaggle/working/COVER/COVER'  # path to COVER repo
CSV_PATH       = '/kaggle/working/CoW_checkpoints/COVER_2D_CoW.csv'
